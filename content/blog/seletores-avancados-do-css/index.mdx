...
No css, serve para selecionar elementos depois de outros elementos, podemos traduzir o "~" para: **"quero pegar todos elementos depois desse elemento"** por exemplo, temos a seguinte marcação HTML:
